...
AS 
BEGIN
	SELECT t.name AS [Tên bàn],  DateCheckIn AS [T? ngày], DateCheckOut AS [T?i ngày], discount AS [Gi?m giá],b.totalPrice AS [T?ng ti?n (000 VND)]
...
BEGIN
	...
	;WITH BillShow AS( SELECT b.ID, t.name AS [Tên bàn], b.totalPrice AS [T?ng ti?n], DateCheckIn AS [T? ngày], DateCheckOut AS [T?i ngày], discount AS [Gi?m giá]
	FROM dbo.Bill AS b,dbo.TableFood AS t
	WHERE DateCheckIn >= @checkIn AND DateCheckOut <= @checkOut AND b.status = 1
	AND t.id = b.idTable)
...
insert into TABLEFOOD(ID,NAME,STATUS) values(1,N'Bàn 1',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(2,N'Bàn 2',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(3,N'Bàn 3',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(4,N'Bàn 4',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(5,N'Bàn 5',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(6,N'Bàn 6',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(7,N'Bàn 7',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(8,N'Bàn 8',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(9,N'Bàn 9',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(10,N'Bàn 10',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(11,N'Bàn 11',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(12,N'Bàn 12',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(13,N'Bàn 13',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(14,N'Bàn 14',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(15,N'Bàn 15',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(16,N'Bàn 16',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(17,N'Bàn 17',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(18,N'Bàn 18',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(19,N'Bàn 19',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(20,N'Bàn 20',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(21,N'Bàn 21',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(22,N'Bàn 22',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(23,N'Bàn 23',N'Tr?ng')
insert into TABLEFOOD(ID,NAME,STATUS) values(24,N'Bàn 24',N'Tr?ng')
...
INSERT FOODCATEGORY(ID,NAME) VALUES (2,N'?á xay')
